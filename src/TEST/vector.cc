...
TEST(vector_max_size, case1) {
  ...
  EXPECT_EQ(s21_vec_int.max_size(), std_vec_int.max_size() * 2 + 1);
  EXPECT_EQ(s21_vec_double.max_size(), std_vec_double.max_size() * 2 + 1);
  EXPECT_EQ(s21_vec_string.max_size(), std_vec_string.max_size() * 2 + 1);
}
